...
local client_proxy = require "pgsql_proxy_client_message"
local server_proxy = require "pgsql_proxy_server_message"
...
function _M.run()
    ...
    local address_key = string.format("pgsql_%d", ngx.var.server_port)
